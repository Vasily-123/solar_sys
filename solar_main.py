...
def init_ui(screen):
    ...
    button_load1 = thorpy.make_button("Solar system", func=open_file1)
    button_load2 = thorpy.make_button("Double_star", func=open_file2)
    button_load3 = thorpy.make_button("Load save", func=open_file3)
    timer = thorpy.OneLineText("Seconds passed")

    button_write = thorpy.make_button("Save data", func=write_space_objects_data_to_file("written.txt", space_objects))
    button_load = thorpy.make_button(text="Load a file", func=open_file1)
